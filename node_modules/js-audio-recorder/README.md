...
安装：
```
npm i js-audio-recorder --registry https://yd-artifact.srdcloud.cn/artifactory/api/npm/szrobot-release-npm-local/
```
调用：
``` js
import Recorder from 'js-audio-recorder/index';
